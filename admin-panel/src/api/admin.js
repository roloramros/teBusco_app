...
export const getChoferes = (params) => api.get('/api/admin/choferes', { params }).then(res => res.data.data);
...
export const getUsuarios = (params) => api.get('/api/admin/usuarios', { params }).then(res => res.data.data);
...
export const getSolicitudes = (params) => api.get('/api/admin/solicitudes', { params }).then(res => res.data.data);
