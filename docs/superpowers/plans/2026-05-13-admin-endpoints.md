...
**Goal:** Implement a comprehensive administration module for Te Busco API, including stats, driver and user management, request monitoring, and broadcast notifications.

**Architecture:** A new `adminController.js` will house all admin-related logic, and `admin.js` will define the routes protected by `authenticate` and `authorize('admin')` middleware. The router will be integrated into the main `index.js`.

**Tech Stack:** Node.js, Express 5, ES Modules, PostgreSQL (pg client), Firebase Admin.

---

### Task 1: Setup Routes and Integration

**Files:**
- Create: `tebusco-api/src/routes/admin.js`
- Modify: `tebusco-api/src/index.js`

- [ ] **Step 1: Create the admin router with basic protection**
...
- [ ] **Step 2: Register the admin router in `index.js`**
...
```bash
git add tebusco-api/src/routes/admin.js tebusco-api/src/index.js
git commit -m "feat(admin): setup admin routes and integration"
```

---

### Task 2: Implement Admin Stats Endpoint

**Files:**
- Create: `tebusco-api/src/controllers/adminController.js`
- Modify: `tebusco-api/src/routes/admin.js`

- [ ] **Step 1: Implement `getStats` in `adminController.js`**
...
- [ ] **Step 2: Register the route in `admin.js`**
...
```bash
git add tebusco-api/src/controllers/adminController.js tebusco-api/src/routes/admin.js
git commit -m "feat(admin): implement stats endpoint"
```

---

### Task 3: Driver Management - List and Detail

**Files:**
- Modify: `tebusco-api/src/controllers/adminController.js`
- Modify: `tebusco-api/src/routes/admin.js`

- [ ] **Step 1: Implement `getChoferes` in `adminController.js`**
...
- [ ] **Step 2: Implement `getChoferById` in `adminController.js`**
...
- [ ] **Step 3: Register routes in `admin.js`**
...
- [ ] **Step 4: Commit driver management**

```bash
git add tebusco-api/src/controllers/adminController.js tebusco-api/src/routes/admin.js
git commit -m "feat(admin): driver list and detail endpoints"
```

---

### Task 4: Driver Management - Approve and Reject

**Files:**
- Modify: `tebusco-api/src/controllers/adminController.js`
- Modify: `tebusco-api/src/routes/admin.js`

- [ ] **Step 1: Implement `aprobarChofer` in `adminController.js`**
...
- [ ] **Step 2: Implement `rechazarChofer` in `adminController.js`**
...
- [ ] **Step 4: Commit approval/rejection**

```bash
git add tebusco-api/src/controllers/adminController.js tebusco-api/src/routes/admin.js
git commit -m "feat(admin): approve and reject driver endpoints"
```

---

### Task 5: User Management - List and Toggle Active

**Files:**
- Modify: `tebusco-api/src/controllers/adminController.js`
- Modify: `tebusco-api/src/routes/admin.js`

- [ ] **Step 1: Implement `getUsuarios` in `adminController.js`**
...
- [ ] **Step 2: Implement `toggleUsuarioActivo` in `adminController.js`**
...
```bash
git add tebusco-api/src/controllers/adminController.js tebusco-api/src/routes/admin.js
git commit -m "feat(admin): user list and toggle active endpoints"
```

---

### Task 6: Request Monitoring

**Files:**
- Modify: `tebusco-api/src/controllers/adminController.js`
- Modify: `tebusco-api/src/routes/admin.js`

- [ ] **Step 1: Implement `getSolicitudes` in `adminController.js`**
...
- [ ] **Step 2: Register route in `admin.js`**

```javascript
router.get('/solicitudes', adminController.getSolicitudes)
```

- [ ] **Step 3: Commit request monitoring**

```bash
git add tebusco-api/src/controllers/adminController.js tebusco-api/src/routes/admin.js
git commit -m "feat(admin): request monitoring endpoint"
```

---

### Task 7: Broadcast Notifications

**Files:**
- Modify: `tebusco-api/src/controllers/adminController.js`
- Modify: `tebusco-api/src/routes/admin.js`

- [ ] **Step 1: Implement `broadcastNotification` in `adminController.js`**
...
- [ ] **Step 3: Commit broadcast**

```bash
git add tebusco-api/src/controllers/adminController.js tebusco-api/src/routes/admin.js
git commit -m "feat(admin): broadcast notification endpoint"
```
